...
class BMIGraph(object):
    ...
    def calculateCorrelationCoefficient(self):
        return self.getNumberOfPoints() * self.sumXY() - (self.sumX() * self.sumY()) / sqrt(self.getNumberOfPoints() * self.sumXSquared() - (self.sumX() ** 2)) * (self.getNumberOfPoints() - self.sumY() ** 2)
    ...
    def debug(self):
        ...
        print(self.calculateCorrelationCoefficient())
